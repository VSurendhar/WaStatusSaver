package com.voiddevelopers.wastatussaver.data.prefdatastoremanager
...
class DataStorePreferenceManagerImpl(private val context: Context) : DataStorePreferenceManager {
    ...
    companion object DataStoreKeys {
        ...
        val KEY_QUICK_SAVE_USER_PREF = stringPreferencesKey("key.quick.save.user.pref")
        val KEY_BACK_UP_USER_PREF = stringPreferencesKey("key.back.up.user.pref")
    }
